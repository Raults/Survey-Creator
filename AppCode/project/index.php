      ...
      <div id ="login">
        ...
        <form id = "loginForm" class="form-inline" method="post" action="login_authenticate.php">
          <div class="form-group row">
              Email:<input type="email" name="email" class="form-control" id="email" placeholder="Enter email">
          </div><br>
          <div class="form-group row">
            <label class="sr-only" for="exampleInputPassword3">Password</label>
            Pass: <input type="password"  name="password" class="form-control" id="password" placeholder="Password">
          </div><br>
